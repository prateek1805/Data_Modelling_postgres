...
def process_song_data(spark, input_data, output_data):
    ...
    """
    Description:
        In this module we will process the songs data files and create extract songs table and artist table data from it.
    ...
    # read song data file
    df = spark.read.json(song_data,sep=";", inferSchema =True, header =True).drop_duplicates()
...
def process_log_data(spark, input_data, output_data):
    ...
    """
    Description:
       In this module we will process the songs data files and create extract table time, users and songplays from it.
    :param spark: a spark session instance
    :param input_data: input file path
    :param output_data: output file path
    """
...
def main():
    ...
    output_data = "s3a://udacity-dend/output_res"
